...
public class EyeLayer extends FeatureRenderer<PlayerEntity, PlayerEntityModel<PlayerEntity>> {

    public EyeLayer(FeatureRendererContext<PlayerEntity, PlayerEntityModel<PlayerEntity>> ctx) {
        super(ctx);
    }
