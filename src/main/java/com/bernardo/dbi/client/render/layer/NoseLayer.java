...
public class NoseLayer extends FeatureRenderer<PlayerEntity, PlayerEntityModel<PlayerEntity>> {

    public NoseLayer(FeatureRendererContext<PlayerEntity, PlayerEntityModel<PlayerEntity>> ctx) {
        super(ctx);
    }
