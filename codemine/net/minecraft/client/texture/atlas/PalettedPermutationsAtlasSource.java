...
implements AtlasSource {
    ...
    public void load(ResourceManager resourceManager, AtlasSource.SpriteRegions regions) {
        ...
        this.permutations.forEach((string, identifier) -> map.put(string, Suppliers.memoize(() -> PalettedPermutationsAtlasSource.method_48492((int[])((java.util.function.Supplier)supplier).get(), PalettedPermutationsAtlasSource.method_48486(resourceManager, identifier)))));
