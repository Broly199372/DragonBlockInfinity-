...
public class SignText {
    private static final Codec<Text[]> MESSAGES_CODEC = Codecs.STRINGIFIED_TEXT.listOf().comapFlatMap(messages -> Util.decodeFixedLengthList(messages, 4).map(Text[]::new), messages -> List.of(messages[0], messages[1], messages[2], messages[3]));
